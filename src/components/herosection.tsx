...
const HeroSection = () => {
  ...
  {/* Background Image */}
  <div className="w-[95%] h-[90vh] rounded-xl relative bg-[url('/genzhome2.jpg')] bg-cover bg-center flex flex-col md:flex-row md:items-center">
    
    {/* Orange Overlay with Text */}
    <div className="bg-orange-500/80 text-white px-6 py-8 md:pl-20 md:pt-12 md:pb-12 md:pr-12 rounded-t-xl md:rounded-lg w-full md:max-w-2xl mt-auto md:mt-0">
